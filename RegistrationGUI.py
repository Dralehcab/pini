...
class RegisteringOption(qt.QWidget):
    ...
    def __init__(self, ImagesList, parent=None,):
        ...
        self.initTransform.stateChanged.connect(self.EnableInitTransform)
        self.comboBoxFI.currentIndexChanged.connect(self.FIChanged)
        self.comboBoxMI.currentIndexChanged.connect( self.MIChanged)
        self.comboBoxFIM.currentIndexChanged.connect(self.FIMChanged)
        self.comboBoxMIM.currentIndexChanged.connect(self.MIMChanged)
        self.comboBoxIFIT.currentIndexChanged.connect(self.IFITChanged)
        self.comboBoxIMIT.currentIndexChanged.connect(self.IMITChanged)
        self.initTranformC.currentIndexChanged.connect(self.initTChanged)
        self.SizeX.lineEdit.textChanged.connect(self.SizeXChanged)
        self.SizeY.lineEdit.textChanged.connect(self.SizeYChanged)
        self.SizeZ.lineEdit.textChanged.connect(self.SizeZChanged)

        self.comboBoxMetric.currentIndexChanged.connect(self._MetricChanged)
        self.DemonsIntensityDiff.lineEdit.textChanged.connect(self._DmIntensChanged)
        self.HMutalInfoBins.lineEdit.textChanged.connect(self._HMInfoBinsChanged)
        self.HMutalInfoVar.lineEdit.textChanged.connect(self._HMInfoVarChanged)
        self.MatesMutalInfoBins.lineEdit.textChanged.connect(self._MatesBinsChanged)
        self.NeigCorrRadius.lineEdit.textChanged.connect(self._NeigRadiusChanged)
        self.comboBoxMetricSamp.currentIndexChanged.connect(self._MetricSampChanged)
        self.metricSamplingPerc.lineEdit.textChanged.connect(self._MetricSampValueChanged)
        self.checkBoxGradientF.stateChanged.connect(self.GradientFMetricChanged)
        self.checkBoxGradientM.stateChanged.connect(self.GradientMMetricChanged)

        self.comboBoxInterpo.currentIndexChanged.connect(self._InterpolatorChanged)

        self.comboBoxOptimizerS.currentIndexChanged.connect(self._OptimizerChangedS)
        self.comboBoxOptimizer.currentIndexChanged.connect( self._OptimizerChanged)

        self.GDRS_learningRate.lineEdit.textChanged.connect(self.GDRS_learningRateChanged)
        self.GDRS_minStep.lineEdit.textChanged.connect(self.GDRS_minStepChanged)
        self.GDRS_nbIter.lineEdit.textChanged.connect(self.GDRS_nbIterChanged)
        self.GDRS_relaxationFactor.lineEdit.textChanged.connect(self.GDRS_relaxationFactorChanged)
        self.GDRS_gradMagnitudeTo.lineEdit.textChanged.connect(self.GDRS_gradMagnitudeToChanged)
        self.GDRS_maxStepSize.lineEdit.textChanged.connect(self.GDRS_maxStepSizeChanged)
        self.GDRS_comboBoxEstiLearningRate.currentIndexChanged.connect(self.GDRS_EstiLearningRateChanged)


        self.GD_learningRate.lineEdit.textChanged.connect(self.GD_learningRateChanged)
        self.GD_nbIter.lineEdit.textChanged.connect(self.GD_nbIterChanged)
        self.GD_minValue.lineEdit.textChanged.connect(self.GD_minValueChanged)
        self.GD_windowSize.lineEdit.textChanged.connect(self.GD_windowSizeChanged)
        self.GD_maxStepSize.lineEdit.textChanged.connect(self.GD_maxStepSizeChanged)
        self.GD_comboBoxEstiLearningRate.currentIndexChanged.connect(self.GD_EstiLearningRateChanged)


        self.GDLS_learningRate.lineEdit.textChanged.connect(self.GDLS_learningRateChanged)
        self.GDLS_nbIter.lineEdit.textChanged.connect(self.GDLS_nbIterChanged)
        self.GDLS_minValue.lineEdit.textChanged.connect(self.GDLS_minValueChanged)
        self.GDLS_windowSize.lineEdit.textChanged.connect(self.GDLS_windowSizeChanged)
        self.GDLS_lowerLimit.lineEdit.textChanged.connect(self.GDLS_lowerLimitChanged)
        self.GDLS_upperLimit.lineEdit.textChanged.connect(self.GDLS_upperLimitChanged)
        self.GDLS_espilon.lineEdit.textChanged.connect(self.GDLS_espilonChanged)
        self.GDLS_lineMaxIter.lineEdit.textChanged.connect( self.GDLS_lineMaxIterChanged)
        self.GDLS_maxStepSize.lineEdit.textChanged.connect(self.GDLS_maxStepSizeChanged)
        self.GDLS_comboBoxEstiLearningRate.currentIndexChanged.connect(self.GDLS_EstiLearningRateChanged)

        self.GCLS_learningRate.lineEdit.textChanged.connect( self.GCLS_learningRateChanged)
        self.GCLS_nbIter.lineEdit.textChanged.connect(self.GCLS_nbIterChanged)
        self.GCLS_minValue.lineEdit.textChanged.connect( self.GCLS_minValueChanged)
        self.GCLS_windowSize.lineEdit.textChanged.connect(self.GCLS_windowSizeChanged)
        self.GCLS_lowerLimit.lineEdit.textChanged.connect(self.GCLS_lowerLimitChanged)
        self.GCLS_upperLimit.lineEdit.textChanged.connect(self.GCLS_upperLimitChanged)
        self.GCLS_espilon.lineEdit.textChanged.connect(self.GCLS_espilonChanged)
        self.GCLS_lineMaxIter.lineEdit.textChanged.connect(self.GCLS_lineMaxIterChanged)
        self.GCLS_maxStepSize.lineEdit.textChanged.connect(self.GCLS_maxStepSizeChanged)
        self.GCLS_comboBoxEstiLearningRate.currentIndexChanged.connect(self.GCLS_EstiLearningRateChanged)

        self.Exhau_stepLength.lineEdit.textChanged.connect(self.Exhau_stepLengthChanged)
        self.Exhau_vector.cellChanged.connect(self.ExhauVectorChanged)
        self.LBFGSB_gradConv.lineEdit.textChanged.connect(self.LBFGSB_gradConvChanged)
        self.LBFGSB_nbIter.lineEdit.textChanged.connect(self.LBFGSB_nbIterChanged)
        self.LBFGSB_MaxNbCorrection.lineEdit.textChanged.connect( self.LBFGSB_MaxNbCorrectionChanged)
        self.LBFGSB_MaxNbFuncEval.lineEdit.textChanged.connect( self.LBFGSB_MaxNbFuncEvalChanged)
        self.LBFGSB_CostFunc.lineEdit.textChanged.connect(self.LBFGSB_CostFuncChanged)

        self.powell_nbIter.lineEdit.textChanged.connect( self.powell_nbIterChanged)
        self.powell_nbIterLine.lineEdit.textChanged.connect(self.powell_nbIterLineChanged)
        self.powell_stepLength.lineEdit.textChanged.connect( self.powell_stepLengthChanged)
        self.powell_stepTolerance.lineEdit.textChanged.connect(self.powell_stepToleranceChanged)
        self.powell_valueTolerance.lineEdit.textChanged.connect( self.powell_valueToleranceChanged)

        self.amoeba_sDelta.lineEdit.textChanged.connect( self.amoeba_sDeltaChanged)
        self.amoeba_nbIter.lineEdit.textChanged.connect( self.amoeba_nbIterChanged)
        self.amoeba_convTolPar.lineEdit.textChanged.connect(self.amoeba_convTolParChanged)
        self.amoeba_convTolFun.lineEdit.textChanged.connect( self.amoeba_convTolFunChanged)

        self.idxshift_radius.lineEdit.textChanged.connect( self.idxshift_radiusChanged)
        self.idxshift_small_Para_Var.lineEdit.textChanged.connect( self.idxshift_small_Para_VarChanged)
        self.jac_radius.lineEdit.textChanged.connect(self.jac_radiusChanged)
        self.phshift_radius.lineEdit.textChanged.connect( self.phshift_radiusChanged)
        self.phshift_small_Para_Var.lineEdit.textChanged.connect( self.phshift_small_Para_VarChanged)

        self.ShrinkEdit1.lineEdit.textChanged.connect( self.ShrinkEdit1Changed)
        self.ShrinkEdit2.lineEdit.textChanged.connect( self.ShrinkEdit2Changed)
        self.ShrinkEdit3.lineEdit.textChanged.connect( self.ShrinkEdit3Changed)
        self.ShrinkEdit4.lineEdit.textChanged.connect( self.ShrinkEdit4Changed)
        self.SmoothEdit1.lineEdit.textChanged.connect( self.SmoothEdit1Changed)
        self.SmoothEdit2.lineEdit.textChanged.connect( self.SmoothEdit2Changed)
        self.SmoothEdit3.lineEdit.textChanged.connect( self.SmoothEdit3Changed)
        self.SmoothEdit4.lineEdit.textChanged.connect( self.SmoothEdit4Changed)

        self.checkBxInfo.stateChanged.connect( self.checkBxInfoChanged)
        self.checkBxImages.stateChanged.connect( self.checkBxImagesChanged)
        self.checkBxMetric.stateChanged.connect( self.checkBxMetricChanged)
        self.checkBxTransformImage.stateChanged.connect( self.checkBxTransformImageChanged)

        self.checkBxImages2  .stateChanged.connect( self.checkBxImages2Changed)
        self.checkBxMetric2  .stateChanged.connect( self.checkBxMetric2Changed)
        self.checkBxTransformImage2 .stateChanged.connect(self.checkBxTransformImage2Changed)
        self.outputsSampling.lineEdit.textChanged.connect(self.outputsSamplingChanged)
        ...
        self.startRegistering.clicked.connect( self.startRegisteringChanged)
